...
public class GameMessageFactory {
    ...
    public static GameMessage produceInitManagerMessage(int safetyWords, int pointsToWin, String playerName) {
        GameMessage message = new GameMessage(GameMessage.MessageType.INIT_MANAGER, playerName,
                '.', safetyWords, pointsToWin, false, "");
        return message;
    }
